            ...
            <tr style="width:100%">
              <td>
                <table style="margin-top:32px" align="center" border="0" cellPadding="0" cellSpacing="0" role="presentation" width="100%">
                  <tbody>
                    <tr>
                      <td><h1 style="color:blue;font-size:36px;font-weight:700;margin:30px 0;padding:0;line-height:42px">➕DocBooker</h1></td>
                    </tr>
                  </tbody>
                </table>
                <h1 style="color:#1d1c1d;font-size:36px;font-weight:700;margin:30px 0;padding:0;line-height:42px">Query From ${email}</h1>
                <h1 style="color:#1d1c1d;font-size:20px;font-weight:700;margin:30px 0;padding:0;line-height:42px">Subject:- ${subject} </h1>
                
                <p style="font-size:20px;line-height:28px;margin:16px 0;margin-bottom:30px">${message}</p>
